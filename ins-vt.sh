...
# install v2ray
wget https://raw.githubusercontent.com/kutasari/pribadi/main/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
cd /usr/bin
wget -O add-ws "https://raw.githubusercontent.com/kutasari/pribadi/main/add-ws.sh"
wget -O add-tr "https://raw.githubusercontent.com/kutasari/pribadi/main/add-tr.sh"
chmod +x add-ws
chmod +x add-tr
cd
rm -f ins-vt.sh
